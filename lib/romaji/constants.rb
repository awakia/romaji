...
module Romaji
  ...
  ROMAJI2KANA = {
    "oh"=>"オオ",
    "koh"=>"コウ", "goh"=>"ゴウ", "soh"=>"ソウ", "zoh"=>"ゾウ", "joh"=>"ジョウ",
    "toh"=>"トウ", "doh"=>"ドウ", "noh" => "ノウ", "hoh" => "ホウ", "boh" => "ボウ",
    "poh" => "ポウ", "voh" => "ヴォウ", "foh" => "フォウ", "moh" => "モウ",
    "yoh" => "ヨウ", "roh" => "ロウ", "loh" => "ロウ", "woh" => "ヲウ",
  ...
  ROMAJI2KANA_EXTRA = ROMAJI2KANA.merge ({
    "b"=>"ブ", "c"=>"ク", "d"=>"ド", "f"=>"フ", "g"=>"グ", "h"=>"", "j" => "ジ",
    "k"=>"ク", "l"=>"ル", "m"=>"ム", "p"=>"プ", "q"=>"ク", "r"=>"ー", "s" => "ス",
    "t"=>"ト", "v"=>"ヴ", "w"=>"ウ", "x"=>"クス", "y"=>"ィ", "z"=>"ズ"
  })
  ...
  KANA2ROMAJI = {
    ...
    'ウァ' => ['wha'], 'ウィ' => ['whi'], 'ウ' => ['whu'], 'ウェ' => ['whe'], 'ウォ' => ['who'],
